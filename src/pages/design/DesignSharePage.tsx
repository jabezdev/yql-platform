...
import { Heart, Download, ExternalLink, ArrowLeft, Lock } from "lucide-react";
                    ...
                    {isAuthenticated ? (
                        <>
                            <button
                                ...
                                className="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 text-white/50 hover:text-white/80 transition-colors"
                            >
                                My Designs
                            </button>
                            <button
                ...
                <div className="flex flex-col gap-5 max-w-xs w-full">
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-tl-xl rounded-br-xl p-4">
                            ...
                            <p className="text-xs text-white/50 leading-relaxed mb-3">
                                Sign in to YQL Design Studio to create, save and share your own designs.
                            </p>
                            <button
                                onClick={() => navigate("/login")}
                                className="w-full flex items-center justify-center gap-2 py-2.5 text-xs font-bold text-brand-blue bg-white rounded-tl-lg rounded-br-lg hover:bg-brand-bgLight transition-colors"
