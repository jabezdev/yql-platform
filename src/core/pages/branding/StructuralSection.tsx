...
import { DashboardSectionTitle } from '../../components/ui/DashboardCard';
        ...
        <Section id="empty" title="Empty States + Loading" icon={Sparkles}>
            ...
            <Grid cols={3} className="mb-4">
                <Box>
                    ...
                    <div className="space-y-2.5">
                        <div className="h-4 w-3/4 bg-brand-blue/10 rounded motion-safe:animate-pulse" />
                        <div className="h-4 w-full bg-brand-blue/10 rounded motion-safe:animate-pulse" />
                        <div className="h-4 w-5/6 bg-brand-blue/10 rounded motion-safe:animate-pulse" />
                        <div className="h-4 w-2/3 bg-brand-blue/10 rounded motion-safe:animate-pulse" />
                    </div>
                </Box>
                <Box>
                    <Meta>Card skeleton — light</Meta>
                    <div className="rounded-tl-xl rounded-br-xl border-2 border-brand-blue/8 overflow-hidden">
                        <div className="h-20 bg-brand-blue/8 motion-safe:animate-pulse" />
                        <div className="p-3 space-y-2">
                            <div className="h-3 w-2/3 bg-brand-blue/10 rounded motion-safe:animate-pulse" />
                            <div className="h-3 w-full bg-brand-blue/8 rounded motion-safe:animate-pulse" />
                            <div className="h-3 w-4/5 bg-brand-blue/8 rounded motion-safe:animate-pulse" />
                        </div>
                    </div>
                </Box>
                <Box>
                    ...
                    <div className="space-y-3">
                        {[...Array(3)].map((_, i) => (
                            <div key={i} className="flex items-center gap-2.5 py-2 border-b border-brand-blue/5 last:border-0">
                                <div className="w-8 h-8 rounded-tl-lg rounded-br-lg bg-brand-blue/10 flex-shrink-0 motion-safe:animate-pulse" />
                                <div className="flex-1 space-y-1.5">
                                    <div className="h-3 w-3/4 bg-brand-blue/10 rounded motion-safe:animate-pulse" />
                                    <div className="h-2.5 w-1/2 bg-brand-blue/8 rounded motion-safe:animate-pulse" />
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <Grid cols={3}>
                <Box dark>
                    ...
                    <div className="space-y-2.5">
                        <div className="h-4 w-3/4 bg-white/10 rounded motion-safe:animate-pulse" />
                        <div className="h-4 w-full bg-white/10 rounded motion-safe:animate-pulse" />
                        <div className="h-4 w-5/6 bg-white/10 rounded motion-safe:animate-pulse" />
                        <div className="h-4 w-2/3 bg-white/10 rounded motion-safe:animate-pulse" />
                    </div>
                </Box>
                <Box dark>
                    <Meta light>Card skeleton — dark</Meta>
                    <div className="rounded-tl-xl rounded-br-xl border-2 border-white/10 overflow-hidden">
                        <div className="h-20 bg-white/10 motion-safe:animate-pulse" />
                        <div className="p-3 space-y-2">
                            <div className="h-3 w-2/3 bg-white/10 rounded motion-safe:animate-pulse" />
                            <div className="h-3 w-full bg-white/8 rounded motion-safe:animate-pulse" />
                            <div className="h-3 w-4/5 bg-white/8 rounded motion-safe:animate-pulse" />
                        </div>
                    </div>
                </Box>
                <Box dark>
                    ...
                    <div className="space-y-3">
                        {[...Array(3)].map((_, i) => (
                            <div key={i} className="flex items-center gap-2.5 py-2 border-b border-white/8 last:border-0">
                                <div className="w-8 h-8 rounded-tl-lg rounded-br-lg bg-white/10 flex-shrink-0 motion-safe:animate-pulse" />
                                <div className="flex-1 space-y-1.5">
                                    <div className="h-3 w-3/4 bg-white/10 rounded motion-safe:animate-pulse" />
                                    <div className="h-2.5 w-1/2 bg-white/8 rounded motion-safe:animate-pulse" />
                                </div>
                            </div>
                        ))}
                    </div>
