    ...
    return (
        <Section id="colors" title="Color System" icon={Palette}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
                {[
                    { token: 'brand-darkBlue', hex: '#2f567f', usage: 'Hover + press states on buttons and interactive elements' },
                    { token: 'brand-blue', hex: '#396799', usage: 'Primary: all text, borders, fills, nav active state' },
                    { token: 'brand-lightBlue', hex: '#3d8ccb', usage: 'Secondary: icons, links, info fills, role labels' },
                ].map(({ token, hex, usage }) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                        {[
                            { token: 'brand-yellow', hex: '#fed432', usage: 'Primary accent, highlights' },
                            { token: 'brand-red', hex: '#ef4444', usage: 'Destructive actions' },
                            { token: 'brand-wine', hex: '#bc594f', usage: 'Form error states' },
                            { token: 'brand-green', hex: '#10b981', usage: 'Success indicators' },
                        ].map(({ token, hex, usage }) => (
                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        {[
                            { token: 'brand-gray', hex: '#97abc4', usage: 'Section labels, muted text' },
                            { token: 'brand-bgLight', hex: '#f5f6f8', usage: 'Page bg, card hover bg' },
                            { token: 'white', hex: '#ffffff', usage: 'Card surfaces, inputs, modals' },
                        ].map(({ token, hex, usage }) => (
                            <div key={token} className="rounded-tl-lg rounded-br-lg overflow-hidden border-2 border-brand-blue/15 flex flex-col">
            ...
            <Box className="mb-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                    {[
                        { bg: '#396799', text: '#ffffff', bgLabel: 'brand-blue', textLabel: 'white', ok: true, ratio: '4.6:1', level: 'AA' },
                        { bg: '#396799', text: '#fed432', bgLabel: 'brand-blue', textLabel: 'brand-yellow (icons)', ok: true, ratio: '3.4:1', level: 'AA Large' },
                        { bg: '#ffffff', text: '#396799', bgLabel: 'white', textLabel: 'brand-blue', ok: true, ratio: '4.6:1', level: 'AA' },
                        { bg: '#f5f6f8', text: '#396799', bgLabel: 'brand-bgLight', textLabel: 'brand-blue', ok: true, ratio: '4.4:1', level: 'AA' },
                        { bg: '#fed432', text: '#396799', bgLabel: 'brand-yellow', textLabel: 'brand-blue', ok: true, ratio: '3.5:1', level: 'AA Large' },
                        { bg: '#396799', text: '#396799', bgLabel: 'brand-blue', textLabel: 'brand-blue ← WRONG', ok: false, ratio: '1:1', level: 'FAIL' },
