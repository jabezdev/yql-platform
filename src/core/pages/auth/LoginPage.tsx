...
export default function LoginPage() {
    return (
        <div className="min-h-screen relative flex items-center justify-center bg-brand-bgLight py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="absolute top-0 left-0 hidden lg:block opacity-50">
                <GeometricPattern variant="hero-top-left" size={80} />
            </div>
            <div className="absolute bottom-0 right-0 hidden lg:block opacity-50">
                <GeometricPattern variant="hero-bottom-right" size={80} />
            </div>
