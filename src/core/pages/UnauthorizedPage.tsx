...
export default function UnauthorizedPage() {
    return (
        <div className="min-h-screen bg-brand-bgLight flex items-center justify-center p-4 font-sans text-brand-blue">
            <div className="max-w-xl w-full text-center space-y-8 animate-in fade-in zoom-in duration-300">
                ...
                <div className="relative mx-auto w-32 h-32">
                    ...
                    <div className="relative z-10 w-full h-full bg-white border-4 border-brand-blue rounded-tl-3xl rounded-br-3xl shadow-[8px_8px_0px_0px_rgba(10,22,48,0.3)] flex items-center justify-center">
                ...
                <div className="pt-12 flex justify-center gap-6 opacity-20">
                    <div className="w-8 h-8 rounded-full border-4 border-brand-blue" />
                    <div className="w-8 h-8 rotate-45 border-4 border-brand-blue" />
                    <div className="w-8 h-8 rounded-tl-lg rounded-br-lg border-4 border-brand-blue" />
                </div>
            </div>
        </div>
    );
