...
export function InviteMembersModal({ channelId, onClose }: InviteMembersModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-brand-blueDark/30 backdrop-blur-sm">
            <div className="bg-white rounded-tl-2xl rounded-br-2xl shadow-[6px_6px_0px_0px_rgba(10,22,48,0.15)] w-[400px] max-h-[75vh] flex flex-col overflow-hidden border-2 border-brand-blueDark/10">
                <div className="flex items-center justify-between px-5 py-4 border-b-2 border-brand-blueDark/8 shrink-0">
                    <div className="flex items-center gap-2">
                        <UserPlus size={15} className="text-brand-blue" />
                        <h2 className="text-sm font-bold text-brand-blueDark">Add Members</h2>
                    </div>
                ...
                <div className="px-4 pt-3 pb-2 shrink-0">
                    <div className="flex items-center gap-2 bg-brand-bgLight border-2 border-brand-blueDark/10 rounded-lg px-2.5 py-1.5 focus-within:border-brand-blue/30">
                        ...
                        <input
                            ...
                            className="flex-1 bg-transparent text-sm text-brand-blueDark placeholder-brand-blueDark/30 outline-none"
                        />
                    </div>
                </div>
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar px-2 pb-3">
                    {candidates.length === 0 ? (
                        <p className="text-xs text-brand-blueDark/35 text-center py-6">
                ...
                <div className="px-4 py-3 border-t-2 border-brand-blueDark/8 flex justify-end shrink-0">
                    <button
                        onClick={onClose}
                        className="px-4 py-1.5 bg-brand-blueDark text-white text-xs font-bold rounded-tl-lg rounded-br-lg hover:bg-brand-blue transition-colors"
                    >
                        Done
                    </button>
                </div>
