...
export function SectionTitle({
    ...
    return (
        <div className={`mb-12 md:mb-16 ${alignmentStyles} ${className}`}>
            <h2 className="text-3xl md:text-4xl font-display font-extrabold mb-4 text-brand-blueDark">
                {children} {renderAccent()}
            </h2>
            {subtitle && (
                <p className="text-brand-blueDark/60 font-medium max-w-2xl mx-auto">{subtitle}</p>
            )}
        </div>
    );
}
