            ...
            <Container>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-4">
                    {benefits.slice(0, 3).map((benefit, index) => (
                        <div
                            key={index}
                            className="group relative bg-white border-2 border-brand-blue rounded-tl-2xl rounded-br-2xl shadow-[4px_4px_0px_0px_rgba(10,22,48,0.14)] transition-all duration-200 p-8 overflow-hidden"
                        >
                            {/* Ghost number */}
                            ...
                            <div className="w-11 h-11 bg-brand-yellow rounded-tl-xl rounded-br-xl flex items-center justify-center mb-6 shadow-[2px_2px_0px_0px_rgba(0,0,0,0.12)] text-brand-blue transition-transform duration-200 flex-shrink-0">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    {benefits.slice(3).map((benefit, index) => (
                        <div
                            key={index + 3}
                            className="group flex items-center gap-4 bg-brand-bgLight border-2 border-brand-blue/12 rounded-tl-xl rounded-br-xl p-5 transition-all duration-200"
                        >
                            <div className="w-10 h-10 bg-brand-blue rounded-tl-lg rounded-br-lg flex items-center justify-center flex-shrink-0 text-white shadow-[2px_2px_0px_0px_rgba(10,22,48,0.25)] transition-colors duration-200">
