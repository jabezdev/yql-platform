        ...
        <section className="relative min-h-screen flex items-center justify-center bg-brand-bgLight pt-[72px] overflow-hidden">
            ...
            <Container className="relative z-30 text-center">
                ...
                <div className="max-w-4xl mx-auto py-20 relative">
                    {/* Main Heading */}
                    <h1 className="text-[2rem] md:text-5xl font-display font-extrabold mb-3 tracking-tight leading-tight text-brand-wine">
                        Join our Team, Be a
                    </h1>

                    {/* Program name */}
                    <h2 className="text-5xl md:text-7xl mb-10 font-display font-extrabold tracking-tight text-brand-blue leading-none">
